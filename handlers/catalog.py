...
цена: <tg-spoiler>1850 долларов</tg-spoiler> '''
...
цена: <tg-spoiler>2700 долларов</tg-spoiler>'''
...
цена: <tg-spoiler>112,6 миллионов долларов</tg-spoiler>'''
    await message.answer_photo(photo, caption=text)
...
цена: <tg-spoiler>190 млн долларов</tg-spoiler>
'''
    await message.answer_photo(photo, caption=text)
...
цена: <tg-spoiler>2 млн долларов</tg-spoiler>
'''
    await message.answer_photo(photo, caption=text)
...
цена: <tg-spoiler>90 тыс долларов</tg-spoiler>
'''
    await message.answer_photo(photo, caption=text)